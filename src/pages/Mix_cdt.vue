 ...
 <div class="template">
  ...
  <div class="fixed-center full-width">
    <div class="space-between">
      ...
      <audio controls>
        <source src="~assets/audios/แกะ.mp3" type="audio/mpeg">
      </audio>
      <img
        src="~assets/Mix/แกะ2.png">

      <img src="~assets/images/แกะ.png">
    </div>
  </div>
  <div class="q-gutter-md row">
    <q-btn color="secondary" size="xl" label="ถัดไป" class="absolute-bottom-right" @click="$router.replace('/เกาะ')" />
  </div>
  <div class="q-gutter-md row">
